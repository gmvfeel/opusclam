...
(function(){
  ...
  function injectFooter(){
    ...
    if(slot){ slot.outerHTML = FOOTER_CSS + FOOTER_HTML; }
    // 푸터 연도 자동 갱신 (© 20xx)
    try{
