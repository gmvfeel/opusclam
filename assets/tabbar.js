...
(function (w, d) {
  ...
  var CSS = ''
    ...
    /* ★ 2026-08-14 · 흰 띠 → <b>검정</b> (파트너 지시)
       ...
       ★ 2026-08-15 · #272524(따뜻한 먹빛)를 하루 걸어 보고 <b>되돌렸습니다</b>
         (파트너 판단). 원래의 푸른끼 도는 검정이 맞았습니다.
         ▶ 다시 시험해 보실 일이 있으면 이 줄과 아래 어두운 모드 줄,
           두 곳만 바꾸면 됩니다. 글자색은 손대지 않아도 됩니다 —
           #272524 에서도 대비가 기준(4.5)을 넘는 것을 확인했습니다. */
    ...
    /* 어두운 화면 — 바탕을 순수 블랙에 가깝게 한 단계만 더 낮춥니다
       ...
       ★ 2026-08-15 · 밝은 모드와 함께 #1c1a19 로 갔다가 되돌렸습니다.
         두 모드는 <b>늘 같은 결</b>로 함께 움직여야 합니다. 한쪽만
         바꾸면 기기에 따라 띠 색이 달라 보입니다. */
