...
(function () {
  ...
  var EMP_SEARCH = ['무관', '정규직', '계약직', '프리랜서'];
  var EMP_TYPES  = ['정규직', '계약직', '프리랜서', '아르바이트', '인턴', '병역특례'];
  ...
  var PAY_BANDS = [
    ...
    { label: '2,000만원 미만',           min: 0,    max: 2000 },
    { label: '2,000 ~ 2,400만원',        min: 2000, max: 2400 },
    { label: '2,400 ~ 2,800만원',        min: 2400, max: 2800 },
    { label: '2,800 ~ 3,400만원',        min: 2800, max: 3400 },
    { label: '3,400 ~ 3,800만원',        min: 3400, max: 3800 },
    { label: '3,800만원 이상',           min: 3800, max: null },
