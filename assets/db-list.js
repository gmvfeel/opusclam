  ...
  function init(cfg) {
    ...
    function emptyHtml() {
      ...
      return ''
        ...
        +     (state.filters
              ? '<li>검색칸 옆의 국내/외 · 분야 조건을 함께 걸어 두셨습니다. 그것을 풀고 다시 찾아보십시오.</li>'
              : '')
        +   '</ul>'
