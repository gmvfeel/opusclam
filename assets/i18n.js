...
(function () {
  ...
  /* ★ 2026-08-15c · 국제 콩쿨 아카이브 낱말 13개를 더했습니다.
       기존 2,493 → 2,506개. 새 화면의 글이라 사전을 새로 받지 못하면
       영어·일본어 화면에서 한국어로 나옵니다. */
  var V = '20260815c';
...
/* 내가 넣은 값 기억 — 다시 건드리지 않기 위해 */
  ...
  var API = {
    ...
    /* ★★ 2026-08-15 · 숫자가 섞인 글을 위한 자리표 (파트너 요청) ★★
       ...
       ★ 값이 여럿이면 {0} {1} 로 씁니다
           OCI18N.n('{0}년 {1}월 공연 {2}건', 2026, 8, 12)
    ...
    n: function (tpl, /* ...vals */) {
      ...
      var out = (window.OCI18N && window.OCI18N.t) ? window.OCI18N.t(tpl) : tpl;
