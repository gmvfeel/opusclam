  ...
  function css() {
    ...
    s.textContent = [
      ...
      /* ★ position 을 <b>다시 적지 않습니다.</b> 한 번 relative 로 적었다가
         ...
         relative 는 필요 없습니다. */
      '.ocH-btn{overflow:hidden;animation:ocHFloat 2.6s ease-in-out infinite}',
      /* ★★ 2026-08-20 · 둥둥이 <b>약하다</b>는 지적 — 세 곳을 키웠습니다
         ...
         ★ 빠르기는 <b>세 번 손봤습니다</b> — 3.4s → 3.2s → <b>2.6s</b>
           (파트너 : 「약간만 빠르게」). 오르내림 폭은 <b>10px 그대로</b>
           둡니다. 폭까지 함께 키우면 둥둥이 아니라 <b>튀는 것</b>으로
           보입니다. 더 빠르게 하려면 2.2s 쯤이 한계로 보입니다 —
           그 아래는 눈이 따라가느라 <b>글 읽기를 방해합니다.</b>
